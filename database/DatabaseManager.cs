...
namespace Student_Project
{
    ...
    public class DatabaseManager
    {
        ...
        public static Dictionary<Data_model.Standard, School_student> getStuData(string filePath)
        {
            if (Validation.isDataAvailable(filePath))
            {
                ...
                {
                    var binaryFormatter = new System.Runtime.Serialization.Formatters.Binary.BinaryFormatter();
                    return (Dictionary<Data_model.Standard, School_student>)binaryFormatter.Deserialize(stream);
                }
            }
            else
            {
